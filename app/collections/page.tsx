...
const categories = [
  ...
  { id: "kurti",      index: "04", name: "Kurti",        tagline: "Timeless & Versatile",     accent: "#C6A77D", image: "https://cdn.westra.in/cdn-cgi/image/width=1920,quality=60,format=avif/kurti.jpeg", description: "Elegant kurtis crafted for everyday grace — from casual staples to festive-ready styles. A wardrobe essential reimagined with contemporary cuts and fine fabrics.", items: ["Casual Kurtis", "Printed Kurtis", "Embroidered Kurtis", "Festive Kurtis", "Linen Kurtis", "Anarkali Kurtis"] },
  { id: "tops",       index: "05", name: "Tops",         tagline: "Everyday Elegance",        accent: "#9B6335", image: "https://cdn.westra.in/cdn-cgi/image/width=1920,quality=60,format=avif/tops.jpeg", description: "A thoughtfully curated range of tops — from relaxed everyday basics to statement embellished styles. The foundation of every great outfit.", items: ["Casual Tops", "Printed Tops", "Embroidered Tops", "Crop Tops", "Flowy Tops", "Party Tops"] },
  { id: "bottoms",    index: "06", name: "Bottoms",      tagline: "Grounded in Style",        accent: "#C6A77D", objectPosition: "center 80%", image: "https://cdn.westra.in/cdn-cgi/image/width=1920,quality=60,format=avif/bottoms.jpeg", description: "Beautifully tailored bottoms — from relaxed palazzos to sleek trousers. The perfect foundation to complete every look.", items: ["Palazzos", "Trousers", "Skirts", "Culottes", "Harem Pants", "Printed Bottoms"] },
  { id: "shirts",     index: "07", name: "Shirts",       tagline: "Polished & Refined",       accent: "#8C7E72", image: "https://cdn.westra.in/cdn-cgi/image/width=1920,quality=60,format=avif/shirts.jpeg", description: "Crisp, feminine shirts crafted in premium fabrics for every occasion. From relaxed linen styles to tailored button-downs.", items: ["Linen Shirts", "Printed Shirts", "Oversized Shirts", "Embroidered Shirts", "Formal Shirts", "Casual Shirts"] },
  { id: "frocks",     index: "08", name: "Frocks",       tagline: "Playful Meets Chic",       accent: "#C6A77D", image: "https://cdn.westra.in/cdn-cgi/image/width=1920,quality=60,format=avif/frock.jpeg", description: "Beautifully crafted frocks that blend playful charm with modern silhouettes. From flirty minis to elegant maxis — there's a frock for every mood.", items: ["Casual Frocks", "Printed Frocks", "Embroidered Frocks", "Maxi Frocks", "Party Frocks", "Linen Frocks"] },
];
                ...
                {cat.image && (
                  <div className="mt-8 relative w-full overflow-hidden" style={{ aspectRatio: "4/3" }}>
                    <Image
                      ...
                      alt={cat.name}
                      fill
                      objectPosition={cat.objectPosition ?? "center 10%"}
