...
const categories = [
  { id: "cord-set",   index: "01", name: "Co-ord Set",  tagline: "Co-ordinated Perfection",  accent: "#C6A77D", description: "Effortlessly matched co-ord sets that create a complete, polished look in seconds. Crafted in premium fabrics with meticulous attention to fit and finish.", items: ["Casual co-ord Sets", "Printed Sets", "Embroidered Sets", "Solid Tone Sets", "Linen co-ord Sets", "Party co-ord Sets"] },
  { id: "kaftan",     index: "02", name: "Kaftan",       tagline: "Breezy, Free & Beautiful", accent: "#9B6335", description: "Flowing kaftans that drape with effortless grace — from beach resort mornings to evening gatherings. Each piece is chosen for its fabric quality and movement.", items: ["Printed Kaftans", "Embroidered Kaftans", "Solid Kaftans", "Short Kaftans", "Maxi Kaftans", "Occasion Kaftans"] },
  { id: "salwar",     index: "03", name: "Salwar",       tagline: "Rooted in Grace",          accent: "#8C7E72", description: "Classic salwar silhouettes reimagined with contemporary design sensibility. From everyday comfort wear to festive-ready sets.", items: ["Salwar Kameez", "Patiala Sets", "Palazzo Salwar", "Printed Sets", "Embroidered Sets", "Dupatta Sets"] },
  { id: "two-piece",  index: "04", name: "Two Piece",    tagline: "Mix, Match & Own It",      accent: "#C6A77D", description: "Versatile two-piece sets designed to take you seamlessly from casual afternoons to evening outings. Mix and match, or wear as a set.", items: ["Crop Top Sets", "Co-ord Sets", "Printed Two Piece", "Embellished Sets", "Linen Sets", "Festive Two Piece"] },
  { id: "tops",       index: "05", name: "Tops",         tagline: "Everyday Elegance",        accent: "#9B6335", description: "A thoughtfully curated range of tops — from relaxed everyday basics to statement embellished styles. The foundation of every great outfit.", items: ["Casual Tops", "Printed Tops", "Embroidered Tops", "Crop Tops", "Flowy Tops", "Party Tops"] },
  { id: "shirts",     index: "06", name: "Shirts",       tagline: "Polished & Refined",       accent: "#8C7E72", description: "Crisp, feminine shirts crafted in premium fabrics for every occasion. From relaxed linen styles to tailored button-downs.", items: ["Linen Shirts", "Printed Shirts", "Oversized Shirts", "Embroidered Shirts", "Formal Shirts", "Casual Shirts"] },
  { id: "frocks",     index: "07", name: "Frocks",       tagline: "Playful Meets Chic",       accent: "#C6A77D", description: "Beautifully crafted frocks that blend playful charm with modern silhouettes. From flirty minis to elegant maxis — there's a frock for every mood.", items: ["Casual Frocks", "Printed Frocks", "Embroidered Frocks", "Maxi Frocks", "Party Frocks", "Linen Frocks"] },
];
  ...
  return (
    <div style={{ background: "var(--bg)" }}>
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 mb-20">
        {categories.map((cat) => (
          <section key={cat.id} id={cat.id} className="py-12 md:py-24 md:pb-8">
